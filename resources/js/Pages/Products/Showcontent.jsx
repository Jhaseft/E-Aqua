...
export default function ShowProduct({ product }) {
  ...
  const isWhatsAppOnly = !product.variants?.length || Number(product.price) === 0;
  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-4 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
      ...
      <div className="space-y-6 sticky top-6 self-start font-sans">
        ...
        {!isWhatsAppOnly && selectedVariant && (
